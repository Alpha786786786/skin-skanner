export const features = [
  ...
  },
  {
    ...
    benefits: ['Customized to your service menu', 'Increases treatment bookings', 'Builds client trust', 'Streamlines consultation process'],
    isNew: true,
  },
  {
    title: 'Business Analytics Dashboard',
    description: 'Track your scanner performance and conversion metrics in real-time',
    benefits: ['Real-time conversion tracking', 'Visitor analytics', 'Performance metrics', 'ROI measurement'],
    isNew: false,
  },
  // {
  //   title: 'Branded Experience',
  //   description: "Customize the scanner with your med spa's branding for a cohesive client experience",
  //   benefits: ['Custom logo integration', 'Branded color schemes', 'Personalized messaging', 'Professional presentation'],
  //   isNew: false,
  // },
];
